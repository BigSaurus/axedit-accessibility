...
app (409 controls, with the amp page and grid visible). This is the reference
so future edits don't drift back into guesswork.
...
Grid indices are **0-based**: rows 0–5, columns 0–13 — a "Row.Column"
convention.
